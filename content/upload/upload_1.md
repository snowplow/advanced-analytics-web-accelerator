...
{{% notice note %}}
Please switch back to using the Classic Console if you are using Snowflake's latest UI (Snowsight) to follow the instructions.
{{% /notice %}}
...
database = 'YOUR_DB
```
##### 2.3 Path to the sample_events.csv
```python

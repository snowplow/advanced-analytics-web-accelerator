...
- Contexts (JSON):
  - `webPage`: True by default
  -  `session`: Adds client session context entity to events
  - `geolocation`: 

You can view more optional arguments for `contexts` [here](https://docs.snowplowanalytics.com/docs/collecting-data/collecting-from-own-applications/javascript-trackers/javascript-tracker/javascript-tracker-v3/tracker-setup/initialization-options/)
